...
void Model::load_texture(std::string filename, const std::string suffix, STgaImage &img) {
...
vec3 Model::normal(const vec2 &uvf) const {
    STgaColor c = normalmap.get(uvf[0]*normalmap.width(), uvf[1]*normalmap.height());
